...
function createBlob(){
    ...
    let borderRadios=`${radiusOne}% ${100 - radiusOne}% ${100 - radiusThree}% ${radiusThree}% / ${radiusFour}% ${radiusTwo}% ${100 - radiusTwo}% ${100 - radiusFour}%`
    document.getElementById('blob').style.cssText=`border-radius :  
    ${borderRadios}; height: ${blobHeight}px; width: ${blobWidth}px`
    outputCode.value=`border-radius:${borderRadios};`
}
